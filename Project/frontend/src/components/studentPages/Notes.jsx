      ...
      <div className="p-6 bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{resource.announcements}</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {subjectResources.map((resource) => (
          <div key={resource.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            {/* Header */}
            <div className={`${resource.subject.color} p-6`}>
              <div className="flex items-center justify-between">
                <div className="text-white">
                  <h3 className="text-xl font-semibold">{resource.subject.code}</h3>
                  <p className="text-white/90">{resource.subject.name}</p>
                  <p className="text-white/80 text-sm mt-1">Instructor: {resource.subject.instructor}</p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {resource.classroomUrl && (
                    <button
                      onClick={() => handleExternalLink(resource.classroomUrl, 'Google Classroom')}
                      className="flex items-center justify-center gap-2 py-2 px-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm"
                    >
                  ...
                  {resource.driveUrl && (
                    <button
                      onClick={() => handleExternalLink(resource.driveUrl, 'Google Drive')}
                      className="flex items-center justify-center gap-2 py-2 px-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm"
                    >
