  ...
  return (
    <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={onClick}>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <Badge className={statusColors[assignment.status as keyof typeof statusColors]} variant="secondary">
            {assignment.status.charAt(0).toUpperCase() + assignment.status.slice(1)}
          </Badge>
          <Badge className={priorityColors[assignment.priority as keyof typeof priorityColors]} variant="secondary">
            {assignment.priority}
          </Badge>
        </div>
