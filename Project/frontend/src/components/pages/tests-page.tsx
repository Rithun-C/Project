            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {selectedTest.chapters.map((chapter: string, index: number) => (
...
function TestCard({ test, onClick }: { test: any; onClick: () => void }) {
  const statusColors = {
  ...
  return (
    <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={onClick}>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <Badge className={statusColors[test.status as keyof typeof statusColors]} variant="secondary">
            {test.status.charAt(0).toUpperCase() + test.status.slice(1)}
          </Badge>
          <Badge className={typeColors[test.type as keyof typeof typeColors]} variant="secondary">
            {test.type}
          </Badge>
        </div>
